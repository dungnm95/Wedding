...
<html lang="en-US" class="csstransforms csstransforms3d csstransitions">
    <head>
        ...
        <style type="text/css">div.row{width:960px;}div.login-box-container{width:960px;}header #header-container .sticky-menu-container .sticky-content{max-width:960px;}@media only screen and (min-width : 767px){#main.folio #galleria,#main.clasic #galleria,#main.image_flow #cosmoImageFlow{margin-left:300px;}}</style>
        ...
        <style type="text/css">h1,h2,h3,h4,h5,h6{font-family:"SourceSansPro-Regular"!important;}.single-gallery p.copyright{padding-left:30px;}.page .single-like-container{display:none}.single #main>.featimg>.featmask{position:absolute;width:140%;height:1000px;-webkit-transform:rotate(15deg);-moz-transform:rotate(15deg);-o-transform:rotate(15deg);-ms-transform:rotate(15deg);transform:rotate(15deg);left:0;background:#FFF;margin-top:-1400px;}</style>
